...
import { faHistory, faEllipsisH,faEdit,faInfoCircle,faTrashAlt,faBookMedical,faSignInAlt } from '@fortawesome/free-solid-svg-icons'
import clientData from '../clients/ClientData';
...
const ModalNewClient=(props)=>{
    ...
    return(
            <React.Fragment>
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="select">Status Payement</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <select className="col-md-12" {...register("StatusP")}>
                      <option value="">Please select</option>
                        <option value="client">Payé</option>
                        <option value="client">non Payé </option>
                    </select>
                ...
                <CFormGroup row>
                  ...
                  <select className="col-md-12" {...register("TypeForfait")}>
                      <option value="">Choisissez Type Forfait</option>
                        <option value="client">Mensuel</option>
                        <option value="client">Trimestriel </option>
                    </select>
                  </CCol>
                </CFormGroup>
  ...
  return(
          <React.Fragment>
              ...
              <CButton size="sm" shape="pill" color="secondary" className=""  title="Modifier" style={{position: "relative",float:"left"}}  onClick={() => setLarge(!large)}>
                  <FontAwesomeIcon  size="sm" icon={faEdit}/>
                   ...
                   <CModal 
                      ...
                      >
                      <CModalHeader closeButton>
                          <CModalTitle>Modifier le client : {props.client.nom} {props.client.prenom}</CModalTitle>
                      </CModalHeader>
                      <CModalBody>
                      <CForm action="#" method="post" encType="multipart/form-data" className="form-horizontal" onSubmit={handleSubmit(onSubmit)}>
              ...
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir le CIN" {...register("CIN")}  onChange={(e)=>{setCIN(e.target.value)}}/>
                {formState.errors.CIN  &&errorMessage(formState.errors.CIN.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir l'email" {...register("email")} onChange={(e)=>{setCIN(e.target.value)}}/>
                {formState.errors.email &&errorMessage(formState.errors.email.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="password" placeholder="Veuillez saisir le mot de passe" {...register("password")} onChange={(e)=>{setPassword(e.target.value)}}/>
                  {formState.errors.password &&errorMessage(formState.errors.password.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="password" placeholder="Veuillez confirmer le mot de passe" {...register("confirmPassword")}onChange={(e)=>{setPassword(e.target.value)}}/>
                {formState.errors.confirmPassword &&errorMessage(formState.errors.confirmPassword.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir le numero de telephone" {...register("telephone")} onChange={(e)=>{setTele(e.target.value)}}/>
                {formState.errors.telephone &&formState.errors.telephone.type === "required" &&errorMessage("le numéro de téléphone est obligatoire")}
                 </CCol>
              </CFormGroup>
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir l'adresse'" {...register("adresse")} onChange={(e)=>{setAdresse(e.target.value)}}/>
                {formState.errors.adresse &&errorMessage(formState.errors.adresse.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                    <input className="col-md-12" type="date" {...register("dateNaissance")} onChange={(e)=>{setDateNaissance(e.target.value)}}/>
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                ...
                <CCol xs="12" md="9">
                  <select className="col-md-12" {...register("TypeForfait")} onChange={(e)=>{setTypeForfait(e.target.value)}}>
...
const ModalAssurance=(props)=>{
  const [societeAssurance,setSocieteAssurance]=React.useState(props.client.societeAssurance)
  const [dateDebut,setDateDebut]=React.useState('')
  const [dateFin,setDateFin]=React.useState('')
  const [montant,setMontant]=React.useState('')
  const [typePaiement,setTypePaiement]=React.useState('')
  const schema=yup.object().shape({
    societeAssurance:yup.string().required('La societe Assurance est obligatoire'),
    dateDebut:yup.date().required('La date debut est obligatoire'),
    dateFin:yup.date().required('La date fin est obligatoire'),
    montant:yup.number().min(0,'Le montant doit etre supperieur a zero').required('Le montant est obligatoire'),
  ...
  return(
          <React.Fragment>
              ...
              <CButton size="sm" shape="pill" color="secondary" className=""  title="Assurance" style={{position: "relative",float:"left"}}  onClick={() => setLarge(!large)}>
                  <FontAwesomeIcon  size="sm" icon={faBookMedical}/>
                   ...
                   <CModal 
                      ...
                      >
                      <CModalHeader closeButton>
                          <CModalTitle>Ajouter Assurance : {props.client.nom} {props.client.prenom}</CModalTitle>
                      </CModalHeader>
                      <CModalBody>
                      <CForm action="#" method="post" encType="multipart/form-data" className="form-horizontal" onSubmit={handleSubmit(onSubmit)}>
              ...
              <CFormGroup row>
                ...
                <CCol md="3">
                  <CLabel htmlFor="societeAssurance-input">Société d'assurance</CLabel>
                </CCol>
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir le nom de la societe d'assurance" {...register("societeAssurance")}  onChange={(e)=>{setSocieteAssurance(e.target.value)}}/>
                {formState.errors.societeAssurance &&errorMessage(formState.errors.societeAssurance.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="date" placeholder="Veuillez saisir le prenom" {...register("dateDebut")}  onChange={(e)=>{setDateDebut(e.target.value)}}/>
                {formState.errors.prenom  &&errorMessage(formState.errors.dateDebut.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="date" placeholder="Veuillez saisir la date de Fin" {...register("dateFin")}  onChange={(e)=>{setDateFin(e.target.value)}}/>
                {formState.errors.dateFin  &&errorMessage(formState.errors.dateFin.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir le montant" {...register("montant")}  onChange={(e)=>{setMontant(e.target.value)}}/>
                {formState.errors.montant  &&errorMessage(formState.errors.montant.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                ...
                <CCol xs="12" md="9">
                  <select className="col-md-12" {...register("TypePaiement")} onChange={(e)=>{setTypePaiement(e.target.value)}}>
              ...
              <CButton type="submit" size="sm" color="primary" ><CIcon name="cil-scrubber"/> Ajouter Assurance</CButton>
            <CButton type="reset" size="sm" color="danger"><CIcon name="cil-ban" /> Annuler</CButton>
            </CForm>
                      </CModalBody>
                      <CModalFooter>
...
const ModalInscription=(props)=>{
  const schema=yup.object().shape({
    ...
    nombreHeuresSemaine:yup.number().min(0,"Le nombre d'heures doit etre supperieur a zero").required('Le montant est obligatoire'),
  });
  const defaults={
      nom:props.client.nom,
      prenom:props.client.prenom,
  ...
  return(
          <React.Fragment>
              ...
              <CButton size="sm" shape="pill" color="secondary" className=""  title="Ajouter Inscription" style={{position: "relative",float:"left"}}  onClick={() => setLarge(!large)}>
                  <FontAwesomeIcon  size="sm" icon={faSignInAlt}/>
                   ...
                   <CModal 
                      ...
                      >
                      <CModalHeader closeButton>
                          <CModalTitle>Ajouter Inscription: {props.client.nom} {props.client.prenom}</CModalTitle>
                      </CModalHeader>
                      <CModalBody>
                      <CForm action="#" method="post" encType="multipart/form-data" className="form-horizontal" onSubmit={handleSubmit(onSubmit)}>
              ...
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir le nom de l'activité choisi" {...register("societeAssurance")} />
                {formState.errors.activite &&errorMessage(formState.errors.activite.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                ...
                <CCol xs="12" md="9">
                <input className="col-md-12" type="date" placeholder="Veuillez saisir la date d'inscription" {...register("dateInscription")}  />
                {formState.errors.prenom  &&errorMessage(formState.errors.dateInscription.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                  <CLabel htmlFor="dateFinInscription-input">Date de Fin</CLabel>
                </CCol>
                <CCol xs="12" md="9">
                <input className="col-md-12" type="date" placeholder="Veuillez saisir la date de Fin" {...register("dateFinInscription")}  />
                {formState.errors.dateFinInscription  &&errorMessage(formState.errors.dateFinInscription.message)}
                </CCol>
              </CFormGroup>
              <CFormGroup row>
                <CCol md="3">
                  <CLabel htmlFor="montant-input">Nombre Heures par Semaine</CLabel>
                </CCol>
                <CCol xs="12" md="9">
                <input className="col-md-12" type="text" placeholder="Veuillez saisir le nombre d'heures" {...register("nombreHeureSemaine")}  />
                {formState.errors.nombreHeureSemaine  &&errorMessage(formState.errors.nombreHeureSemaine.message)}
                </CCol>
              </CFormGroup>
              <CButton type="submit" size="sm" color="primary" ><CIcon name="cil-scrubber"/> Ajouter Inscription</CButton>
            <CButton type="reset" size="sm" color="danger"><CIcon name="cil-ban" /> Annuler</CButton>
            </CForm>
                      </CModalBody>
                      <CModalFooter>
